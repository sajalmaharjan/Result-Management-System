...
$sql = "UPDATE $grade SET updatetime='$date', firstname='$firstname', lastname='$lastname', gender='$gender', section='$section', rollno='$rollno', term='$term', sub1pass='$sub1pass', sub2pass='$sub2pass', sub3pass='$sub3pass', sub4pass='$sub4pass', sub5pass='$sub5pass', sub6pass='$sub6pass', sub7pass='$sub7pass', sub8pass='$sub8pass', sub9pass='$sub9pass', sub10pass='$sub10pass', sub11pass='$sub11pass', sub12pass='$sub12pass' WHERE id='$id'";
if (mysqli_query($con, $sql)) {
    header("Location: ".$_SERVER['HTTP_REFERER']);
} else {
	echo "<meta http-equiv='refresh' content='0; url=".$_SERVER['HTTP_REFERER']."'><script>alert('Error while updating result');</script>";
}}
?>